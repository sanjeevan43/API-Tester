...
export class SidebarProvider implements vscode.WebviewViewProvider {
  ...
  public resolveWebviewView(webviewView: vscode.WebviewView) {
    ...
    webviewView.webview.onDidReceiveMessage((data) => {
      switch (data.type) {
        case 'scan':   vscode.commands.executeCommand('apiSentinel.scanProject'); break;
        case 'runAll': vscode.commands.executeCommand('apiSentinel.runAll', data); break;
        case 'saveSettings':
  ...
  public updateEndpoints(endpoints: Endpoint[]) {
  ...
  public setCLIRunning(running: boolean) {
